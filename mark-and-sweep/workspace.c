...
void test_full() {
    ...
    frame_free(vm_frame_pop(vm));
    vm_collect_garbage(vm);
    // assert(boot_is_freed(s3));
    // assert(!boot_is_freed(s1));
    // assert(!boot_is_freed(s2));
    ...
    // assert(boot_is_freed(s2));
    // assert(boot_is_freed(s3));
    // assert(boot_is_freed(v));
    // assert(boot_is_freed(i1));
    // assert(boot_is_freed(i2));
    // assert(boot_is_freed(i3));
